...
class _CustomTheme extends InheritedWidget {
  ...
  const _CustomTheme({Key? key, required this.data, required Widget child}) : super(key: key, child: child);
...
class CustomTheme extends StatefulWidget {
  ...
  const CustomTheme({Key? key, required this.initialThemeKey, required this.child}) : super(key: key);
